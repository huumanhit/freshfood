...
import {
  LayoutDashboard, Package, Tag, ShoppingBag, Users, LogOut,
  Truck, GitMerge, ShoppingCart, Gift, Layers, Settings,
} from "lucide-react";
...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 hidden lg:flex flex-col bg-white border-r border-gray-200 min-h-screen">
      {/* Logo */}
