    ...
    <div className="space-y-4">
      ...
      {!isLoading && categories.length === 0 && (
        <div className="rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-8 text-center space-y-3">
          ...
          <Button onClick={openCreate} className="rounded-xl bg-[#22c55e] hover:bg-[#16a34a]">
                      ...
                      <TableRow key={cat.id}>
                        <TableCell>
                          <div className="flex items-center gap-2">
                            <div className="h-7 w-7 rounded-lg bg-[#22c55e]/10 flex items-center justify-center shrink-0">
        ...
        <DialogContent className="max-w-md">
          ...
          <form onSubmit={handleSubmit((v) => saveMutation.mutate(v))} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={saveMutation.isPending} className="rounded-xl bg-[#22c55e] hover:bg-[#16a34a]">
